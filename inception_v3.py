    ...
    with slim.arg_scope([slim.batch_norm, slim.dropout],
      ...
      with tf.variable_scope(end_point):
        ...
        with tf.variable_scope('Branch_1'):
          ...
          branch_1 = tf.concat(axis=3, values=[
              layers_lib.conv2d(branch_1, depth(384), [1, 3],stride=1,padding='SAME', rate = (1,2), scope='Conv2d_0b_1x3'),
              layers_lib.conv2d(branch_1, depth(384), [3, 1],stride=1,padding='SAME', rate = (2,1), scope='Conv2d_0b_3x1')])
        with tf.variable_scope('Branch_2'):
          ...
          branch_2 = tf.concat(axis=3, values=[
              layers_lib.conv2d(branch_2, depth(384), [1, 3],stride=1,padding='SAME', rate = (1,2), scope='Conv2d_0c_1x3'),
              layers_lib.conv2d(branch_2, depth(384), [3, 1],stride=1,padding='SAME', rate = (2,1), scope='Conv2d_0d_3x1')])
        with tf.variable_scope('Branch_3'):
          branch_3 = slim.avg_pool2d(lip_net, [3, 3],stride=1,padding='SAME',  scope='AvgPool_0a_3x3')##[5,1,2]
          branch_3 = slim.conv2d(
              branch_3, depth(192), [1, 1], scope='Conv2d_0b_1x1')
